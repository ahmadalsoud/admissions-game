// Knox College Admissions Guide Script
function choose(path) {
  console.log('Button clicked with path:', path); // Debug log
  ...
  if (path === 'start') {
    dialogue.innerHTML = '<h3>🎓 Starting Your Knox College Application</h3>' +
    ...
    dialogue.innerHTML = '<h3>📋 After Submitting Your Application</h3>' +
      '<div class="content-section">' +
    ...
    dialogue.innerHTML = '<h3>🎉 Congratulations! You\'re Accepted to Knox College!</h3>' +
      '<div class="content-section">' +
    ...
    dialogue.innerHTML = '<h3>🏫 Knox College Orientation Information</h3>' +
      '<div class="content-section">' +
...
document.addEventListener('DOMContentLoaded', function() {
  console.log('DOM loaded, setting up keyboard navigation');
